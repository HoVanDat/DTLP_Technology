      ...
      <div class="col-md-12">
        ...
        <div class="tile">
          ...
          <div class="tile-body">
            ...
            <form class="row" action="{{ route('edit.qlbanner.post') }}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="form-group col-md-4">
                <label class="control-label">Id banner</label>
                <input class="form-control" type="text" name="id_banner" value="{{$edit->id_banner}}" readonly>
              </div>
              <div class="form-group col-md-4">
