                                                ...
                                                <form action="{{ url('/comments') }}" id="comment-form" method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        <input class="form-control" id="ten"
                                                            value="{{session('userInfo.ten')}}" name="ten" type="hidden"
                                                            readonly>
                                                    </div>
                                                    <div class="form-group">
                                    ...
                                    <div class="single-product" style="margin-bottom:25px;">
                                        <div class="product-f-image">
                                            ...
                                            <div class="product-hover">
                                                <a href="{{ route('muahang',['id' => $splq->id_san_pham]) }}"
                                                    class="add-to-cart-link"><i class="fa fa-shopping-cart"></i>
                                                    Mua ngay</a>
                                                <a href="{{url('chi-tiet-san-pham',[$splq->id_san_pham])}}"
                                                    class="view-details-link"><i class="fa fa-link"></i> Xem thêm</a>
                                            </div>
                                        </div>
