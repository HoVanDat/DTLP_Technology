                ...
                <div class="content-wrapper">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card mb-4">
                                    <div class="w3-bar w3-black">
                                        <button class="w3-bar-item w3-button" onclick="openCity('London')">Thông tin cá
                                            nhân</button>
                                        <button class="w3-bar-item w3-button" onclick="openCity('Paris')">Quản lí đơn
                                            hàng</button>
                                        <button class="w3-bar-item w3-button" onclick="openCity('Tokyo')">Đổi mật
                                            khẩu</button>
                                    </div>
                                                ...
                                                <div class="d-flex align-items-start align-items-sm-center gap-4">
                                                    ...
                                                    <div class="button-wrapper">
                                                        <label for="upload" class="btn btn-primary me-2 mb-4"
                                                            ...
                                                            <input type="file" name="hinh" id="uploadfile"
                                                                class="account-file-input" onchange="readURL(this);" />
                                                        </label>
                                                        <!-- <button type="button"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3 col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="so_dien_thoai"
                                                            name="so_dien_thoai"
                                                            value="{{session('userInfo.so_dien_thoai')}}" />
                                                    </div>

                                                </div>
                                                <div class="mt-2">
                                                    <button type="submit" class="btn btn-primary me-2">Chỉnh
                                                        sửa</button>
                    ...
                    <div id="Paris" class="w3-container city" style="display:none">
                        ...
                        <form action="{{ route('tim-kiem-don-hang') }}" method="get" class="search">
                            <input style="width:50%; border:1px solid #cccccc" class="input" type="text" name="tu-khoa"
                                placeholder="Có thể tìm kiếm tên sản phẩm hoặc mã đơn hàng">
                            <button style="border:none; background-color:#F17024; color:white;" type="submit">Tìm
                                kiếm</button>
                        </form>
                        ...
                        <div class="donhang">
                            ...
                            <div style="padding:20px; margin-top:20px;" class="tong">
                                ...
                                <div class="donhang3">
                                    <h4>Tổng đơn hàng: {{ number_format($donhang->tong_don_hang, 0, ',', '.') }} VND
                                    </h4>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Chi tiết đơn
                                                        hàng</h1>
                                                    ...
                                                    <div class="fulldonhang">
                                                        ...
                                                        <div class="donhang2">
                                                            <div class="row">
                                                                <div class="col-6">
                                                                    ...
                                                                    $tt3 =
                                                                    DB::table('sanpham')->where('id_san_pham',$t->id_san_pham)->get();
                                                        ...
                                                        <div class="ful3">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-6">
                                                                    <p>Tổng: <span>{{ number_format($donhang->tong_don_hang, 0, ',', '.') }}
                                                                            VND</span></p>
                                                                    <p>Ship: 0đ</p>
                                                                    <p>Thanh toán:
                                                                        <span>{{ number_format($donhang->tong_don_hang, 0, ',', '.') }}
                                                                            VND</span>
                                                                    </p>
                                                                </div>
                                                            </div>
